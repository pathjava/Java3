...
public class RunTask {
    ...
    public static void main(String[] args) {
        ApplicationContext context
                = new ClassPathXmlApplicationContext("taskAnnotationsContext.xml");
        fileTask = context.getBean("fileTaskRepository", FileTaskRepository.class);
        RunTask runTask = context.getBean("runTask", RunTask.class);
